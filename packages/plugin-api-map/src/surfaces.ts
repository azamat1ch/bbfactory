    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "List enabled providers, include disabled installed providers for administration, and change exact provider enablement through sdk.providers.experimental_setEnabled",
        ...
        apiSymbols: ["BbPluginApi", "PluginServerApi", "ProvidersArea"],
        firstParty: [
          "Automations",
          "Docs",
          "GitHub",
