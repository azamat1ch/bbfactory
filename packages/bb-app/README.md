...
| `devin`        | Install [Devin CLI](https://docs.devin.ai/cli) and authenticate with `devin auth login`; it serves ACP with `devin acp`.                                                                |

BB indexes the documented native skill roots for Codex, Claude Code, Pi,
Cursor, OpenCode, omp, Grok Build, Hermes Agent, and Devin. It includes user roots,
