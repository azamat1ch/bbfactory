...
import { migrations } from "../execution/data.js";
import { registerExecutionRpc } from "../execution/execution.js";
import { createWorkflowService } from "../execution/service.js";
...
it("carries two selected assignments through real Workflows and only accepts checked integration content", async () => {
  ...
  const handlers = registerExecutionRpc(native.bb, nativeDb.$client, execution);
